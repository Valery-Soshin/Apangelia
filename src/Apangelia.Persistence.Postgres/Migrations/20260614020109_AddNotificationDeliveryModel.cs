...
public partial class AddNotificationDeliveryModel : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_NotificationDeliveryAttempts_NotificationDeliveries_NotificationDeliveryId",
        ...
        migrationBuilder.CreateIndex(
            name: "IX_NotificationDeliveryAttempts_NotificationDeliveryId_StartedAt",
    ...
    {
        migrationBuilder.DropTable(name: "NotificationDeliveryAttempts");

        migrationBuilder.DropTable(name: "NotificationDeliveries");

        migrationBuilder.DropTable(name: "NotificationRoutes");
    }
}
